...
- **Formatting Standards:** Prettier (single quotes, blank lines around headers). Obsidian (WikiLinks `[[Link]]`, YAML front matter). Tables: pad columns to equal width, dashes fill full width.
